    ...
    <section class="w3l-grids">
        <div class="grids-main py-4">
            <div class="container py-lg-4">
                ...
                <div class="owl-four owl-carousel owl-theme owl-loaded owl-drag">
                    <div class="owl-stage-outer">
                        <div class="owl-stage"
                            style="transform: translate3d(-986px, 0px, 0px); transition: all; width: 3454px;">
                            <div class="owl-item cloned" style="width: 473.4px; margin-right: 20px;">
                            ...
                            <div class="owl-item active" style="width: 473.4px; margin-right: 20px;">
                                <div class="item vhny-grid">
                                    <div class="box16">
                                        <a href="#">
                                            <figure>
                            ...
                            <div class="owl-item" style="width: 473.4px; margin-right: 20px;">
                                <div class="item vhny-grid">
                                    <div class="box16">
                                        <a href="#">
                                            <figure>
                    ...
                    <div class="owl-nav"><button type="button" role="presentation" class="owl-prev"><span
                                aria-label="Previous"> <span class="fa fa-angle-left"></span> </span></button><button
                            type="button" role="presentation" class="owl-next"><span aria-label="Next"> <span
                                    class="fa fa-angle-right"></span> </span></button></div>
                ...
                <div class="headerhny-title">
                    <div class="w3l-title-grids">
                        ...
                        <div class="headerhny-right text-lg-right">
                            <h4><a class="show-title" href="{{ route('categories') }}">Back</a></h4>
                        </div>
                    </div>
                </div>

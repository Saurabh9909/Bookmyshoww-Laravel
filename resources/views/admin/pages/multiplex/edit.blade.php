                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-6">
                        <div class="card">
                            ...
                            <form action="{{ route('multiplex.update',$multiplex_list->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="multiplex_name" class="form-control"
                                                ...
                                                value="{{ $multiplex_list->multiplex_name }}">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control select2" name="location[]">
                                                    @foreach ($location as $key => $item)
                                                        @if ($item->name == $multiplex_list->location)
                                                            <option value="{{ $multiplex_list->location }}" selected>
                                                                {{ $multiplex_list->location }}
                                                            </option>
                                                        @else

                                            ...
                                            <select class="form-control select2" name="show_id" id="show_id" required>
                                                @foreach ($shows as $show)
                                                    <option value="{{ $show->id }}"
                                                        {{ $ticket->show_id == $show->id ? 'selected' : '' }}>
                                                        {{ $show->id }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                            ...
                                            <select class="form-control select2" name="admin_id" id="admin_id" required>
                                                @foreach ($admins as $admin)
                                                    <option value="{{ $admin->id }}"
                                                        {{ $ticket->admin_id == $admin->id ? 'selected' : '' }}>
                                                        {{ $admin->name }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="ticket_no" class="form-control" id="ticket_no"
                                                value="{{ $ticket->ticket_no }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" name="show_date" class="form-control" id="show_date"
                                                value="{{ $ticket->show_date }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" name="price" class="form-control" id="price"
                                                value="{{ $ticket->price }}" step="0.01" required>
                                        </div>
                                    </div>
